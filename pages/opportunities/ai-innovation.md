...
subnav:
  ...
  - text: Proposal guidelines
    href: '#proposal-guidelines'
  - text: Scope
    href: '#scope'
  - text: Topics that will not be considered for funding
    href: '#topics-that-will-not-be-considered-for-funding'
  - text: Project Funding
    href: '#project-funding'
  - text: Proposal format and submission
    href: '#proposal-format-and-submission'
  - text: Definition of AI/ML technologies
    href: '#definition-of-ai/ml-technologies'
